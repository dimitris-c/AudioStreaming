...
final class AudioPlayerRenderProcessor: NSObject {
    ...
    func render(inNumberFrames: UInt32, ioData: UnsafeMutablePointer<AudioBufferList>, status: OSStatus) -> OSStatus {
        ...
        rendererContext.outAudioBufferList[0].mBuffers.mNumberChannels = UnitDescriptions.canonicalAudioStream.mChannelsPerFrame  //UnitDescriptions.canonicalAudioStream.mChannelsPerFrame
...
//                ioData.pointee.mBuffers.mDataByteSize = frameSizeInBytes * frameToCopy
//                
//                if isMuted {
//                    memset(bufferList.mBuffers.mData, 0, Int(bufferList.mBuffers.mDataByteSize))
//                } else {
